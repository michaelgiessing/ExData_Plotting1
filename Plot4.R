...
#plot4
par( mfrow=c(2,2))
plot(power1$datetime, GAP, type = "l", xlab="", ylab="Global Active Power (Kilowatts)")
with(power1, plot(datetime, Voltage, type = "l"))
...
with(power1, plot(datetime, Global_reactive_power, type = "l"))
